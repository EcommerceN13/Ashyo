  ...
  return (
   <div className='w-full product-item duration-300'>
        <div className='bg-[#EBEFF3] relative rounded-[8px] mb-[16px] flex items-center justify-center h-[280px]'>
            <Image className='product-img duration-300' style={{width:"202px" , height:"202px"}} src={`${IMAGE_API}${item.product.image}`} width={202} height={202} alt='Product img' priority/>
        ...
        <p className='text-[18px] font-normal leading-[19px] text-[#545D6A] mb-[28px]'>{item.product.name}</p>
